  ...
  return (
    <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f3ece7] px-10 py-3">
      <div className="flex items-center gap-4 text-[#1b130d]">
        ...
        <h2 className="text-[#1b130d] text-lg font-bold leading-tight tracking-[-0.015em]">Cafe Caramel</h2>
      </div>
      <div className="flex flex-1 justify-end gap-8">
        ...
        <button className="flex max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-xl h-10 bg-[#f3ece7] text-[#1b130d] gap-2 text-sm font-bold leading-normal tracking-[0.015em] min-w-0 px-2.5">
